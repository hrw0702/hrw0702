...
hl.common = {
	...
	CursorLineNr = { fg = c.fg, bg = c.dark_cyan },
	LineNr = { fg = c.grey },
...
hl.syntax = {
	...
	Keyword = { fg = c.dark_yellow, fmt = cfg.code_style.keywords },
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
	hl.treesitter = {
		...
		["@include"] = colors.Purple,
		-- ["@keyword"] = { fg = c.purple, fmt = cfg.code_style.keywords },
		["@keyword"] = { fg = c.cyan, fmt = cfg.code_style.keywords },

		-- ["@keyword.function"] = { fg = c.purple, fmt = cfg.code_style.functions },
		["@keyword.function"] = { fg = c.fg, fmt = cfg.code_style.functions },
	...
	hl.treesitter = {
		...
		TSStringEscape = { fg = c.light_grey, fmt = cfg.code_style.strings },
		...
		TSVariableBuiltin = { fg = c.light_grey, fmt = cfg.code_style.variables },
	}
end
